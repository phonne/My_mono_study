<div class="col-xs-6 span6">
    <div class="carousel slide" id="carousel-685276">
        ...
        <div class="carousel-inner">
            <div class="item">
                <img alt="here is picture 1" src="img/test1.png" width="1356" height="850" />
            ...
            <div class="item">
                <img alt="here is picture 2" src="img/test2.png" width="1356" height="850" />
                <div class="carousel-caption">
                    <p>
                       test2
                    </p>
            ...
            <div class="item active">
                <img alt="here is picture 3" src="img/test3.png" width="1356" height="850" />
                <div class="carousel-caption">
                    <p>
                       test3
                    </p>
